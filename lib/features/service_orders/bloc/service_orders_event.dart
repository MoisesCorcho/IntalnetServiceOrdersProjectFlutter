...
// --- EVENTO AÑADIDO PARA LAS PESTAÑAS ---
class ServiceOrdersFilterChanged extends ServiceOrdersEvent {
  const ServiceOrdersFilterChanged({this.status});

  // El filtro de estado (ej: 'created' o null para 'Asignadas')
  final String? status;
